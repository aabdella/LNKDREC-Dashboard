...
- technologies/tools: Extract ALL from their respective sections. Do NOT duplicate items already in the skills array — each item should appear in only ONE array (whichever is the most specific match).

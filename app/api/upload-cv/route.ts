...
Schema:
{
  ...
  "skills": "array of strings (Extract EVERY individual skill mentioned anywhere in the CV text — programming languages, design skills, soft skills, methodologies, tools proficiency, everything. Cast a wide net. Read the entire CV and list every skill you find. Include things like: team management, problem solving, agile, budgeting, negotiation, client relations, copywriting, SEO, etc. The goal is completeness — if someone mentions it as a capability, include it. Do NOT filter or prioritize. If you see 50 skills, include all 50)",
  "technologies": "array of { name: string, years: number } (EVERY technology, programming language, framework, platform mentioned — React, Python, AWS, Docker, SQL, WordPress, etc. Cast a wide net. Include every single one you find anywhere in the CV)",
  "tools": "array of { name: string, years: number } (EVERY specific software application mentioned — Figma, Jira, Photoshop, Excel, Salesforce, Google Analytics, Trello, Notion, etc. Include every single one you find anywhere in the CV)",

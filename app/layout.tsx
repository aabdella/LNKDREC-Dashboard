            ...
            <header className="bg-black text-white shadow-lg sticky top-0 z-50 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="max-w-7xl mx-auto px-4 py-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-6">
                      ...
                      <nav className="hidden md:flex gap-6 ml-4 text-sm font-medium text-zinc-400">
                          ...
                          <Link href="/knowledge-base" className="hover:text-white transition py-2 border-b-2 border-transparent hover:border-white flex items-center gap-1.5">
                            <BookOpenIcon className="h-4 w-4" />Knowledge Base
                          </Link>
                      </nav>
                  </div>
                ...
                <nav className="md:hidden mt-3 pt-3 border-t border-zinc-800 flex gap-4 text-sm font-medium text-zinc-400 overflow-x-auto">
                  ...
                  <Link href="/knowledge-base" className="hover:text-white transition whitespace-nowrap flex items-center gap-1">
                    <BookOpenIcon className="h-4 w-4" />Knowledge Base
                  </Link>
                </nav>
              </div>
